...
public class BluetoothChatService {
    ...
    public static boolean dataProcess = false;
     ...
     */
    public BluetoothChatService(Context context, Handler handler, Handler dhandler) {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(BluetoothMain.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public void setDataProcess(boolean state) {
        dataProcess = state;
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        Message msg = mHandler.obtainMessage(BluetoothMain.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothMain.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(BluetoothMain.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothMain.TOAST, "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(BluetoothMain.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothMain.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
